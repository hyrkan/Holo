...
<head>
    ...
    <title>Holo Board || Admin Reset Password</title>
            ...
            <div class="minimal-card-wrapper">
                <div class="card mb-4 mt-5 mx-4 mx-sm-0 position-relative">
                    ...
                    <div class="card-body p-sm-5">
                        ...
                        <h4 class="fs-13 fw-bold mb-2">Create a new admin password</h4>
                        <p class="fs-12 fw-medium text-muted">Enter your new password below to reset your admin account.</p>
                        @if ($errors->any())
                        ...
                        <form action="{{ route('admin.password.store') }}" method="POST" class="w-100 mt-4 pt-2">
                            ...
                            <div class="mb-4">
                                <input type="email" name="email" class="form-control" placeholder="Admin Email Address" value="{{ $email }}" required>
                            </div>
                            <div class="mb-3">
